...
CREATE OR REPLACE TABLE CUSTOMER_DEMOGRAPHICS (
    ...
    MARKETING_PREFERENCES VARCHAR(100),
...
COPY INTO CUSTOMER_DEMOGRAPHICS(
    ...
    HOUSEHOLD_INCOME_GBP, OCCUPATION, EDUCATION_LEVEL, LOCATION, REGION,
    DRIVING_EXPERIENCE_YEARS, PRIMARY_USE_CASE, PREFERRED_FUEL_TYPE, 
    BUDGET_RANGE_GBP, CREDIT_SCORE, MARKETING_PREFERENCES, LOYALTY_PROGRAM_MEMBER
)
FROM (
    SELECT 
        $1 AS CUSTOMER_ID,
        ...
        $10 AS LOCATION,
        $11 AS REGION,
        TRY_TO_NUMBER($12) AS DRIVING_EXPERIENCE_YEARS,
        $13 AS PRIMARY_USE_CASE,
        $14 AS PREFERRED_FUEL_TYPE,
        $15 AS BUDGET_RANGE_GBP,
        TRY_TO_NUMBER($16) AS CREDIT_SCORE,
        $17 AS MARKETING_PREFERENCES,
        CASE WHEN $18 = 'True' THEN TRUE ELSE FALSE END AS LOYALTY_PROGRAM_MEMBER
